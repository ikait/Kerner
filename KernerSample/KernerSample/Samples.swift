...
let Sentences = [
    ...
    "経書けいしょ・史類の奥義には達したれども商売の法を心得て正しく取引きをなすこと能あたわざる者は、これを帳合いの学問に拙つたなき人と言うべし。",
    "数年の辛苦を嘗め、数百の執行金しゅぎょうきんを費やして洋学は成業したれども、なおも一個私立の活計をなし得ざる者は、時勢の学問に疎うとき人なり。",
    ...
    "書中に記すところは、西洋の諸書よりあるいはその文を直ちに訳し、あるいはその意を訳し、形あることにても形なきことにても、一般に人の心得となるべき事柄を挙あげて学問の大趣意を示したるものなり。",
    "先に著あらわしたる一冊を初編となし、なおその意を拡おしひろめてこのたびの二編を綴り、次いで三、四編にも及ぶべし。"
]
